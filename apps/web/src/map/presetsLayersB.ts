...
export const ALL_LAYERS_PART_B: LayerEntry[] = [
  ...
  { id: "named-canals",       label: "Major canals (sketch)",  swatch: "#1955C3", group: "environment",
  ...
  { id: "regional-rivers",    label: "Tapi River (sketch)",     swatch: "#163E96", group: "environment",
  ...
  { id: "historical-floods",  label: "Dec 2024 flood outlines (sketch)", swatch: "#DC2626", group: "environment",
  ...
  { id: "provincial-roads",  label: "Highways (sketch)",     swatch: "#DC8226", group: "municipality",
