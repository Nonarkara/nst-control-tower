...
export const ALL_LAYERS_PART_B: LayerEntry[] = [
  ...
  { id: "city-pois",          label: "City places (Old Town)",   swatch: "#FFC300", group: "municipality",
    describe: "Hand-authored from the official Nakhon Si Thammarat City Municipality Map (1:50,000 scale). 48 important places across 7 categories: 15 hotels (blue), 7 temples + 1 landmark (gold, Wat Phra Mahathat is the largest), 3 hospitals (red), 3 markets (orange), 5 important places (slate — stadium, college, municipal office, police, court), 10 tourist attractions (green), 4 restaurants (pink). City-scale visibility so the operator can find specific destinations without searching by name." },
  { id: "provincial-roads",  label: "Provincial highways",     swatch: "#DC8226", group: "municipality",
    describe: "Hand-authored from the panteethai.com NST road map. 22 routes covering the national spines (Hwy 41 N-S, Hwy 4 Phetkasem E-W) + 20 provincial 4-digit routes connecting districts to NST City. National highways render as yellow-orange double-stroke; provincials as grey. Highway shield numbers (41, 401, 403, 408, 4103, etc.) shown as labels at each route midpoint so the operator can identify the route without the printed-map legend." },
